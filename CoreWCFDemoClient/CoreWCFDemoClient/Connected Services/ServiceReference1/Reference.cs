...
namespace EchoService
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="EchoMessage", Namespace="http://schemas.datacontract.org/2004/07/CoreWCFDemoServer.CoreWCfDemoServer")]
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="EchoFault", Namespace="http://schemas.datacontract.org/2004/07/CoreWCFDemoServer.CoreWCfDemoServer")]
    ...
    public interface IEchoService
    {
        ...
        System.Threading.Tasks.Task<string> ComplexEchoAsync(EchoService.EchoMessage text);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(EchoService.EchoFault), Action="http://tempuri.org/IEchoService/FailEchoEchoFaultFault", Name="EchoFault", Namespace="http://schemas.datacontract.org/2004/07/CoreWCFDemoServer.CoreWCfDemoServer")]
    ...
    public partial class EchoServiceClient : System.ServiceModel.ClientBase<EchoService.IEchoService>, EchoService.IEchoService
    {
        ...
        public System.Threading.Tasks.Task<string> ComplexEchoAsync(EchoService.EchoMessage text)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IEchoService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:5000/EchoService/basichttp");
            }
            if ((endpointConfiguration == EndpointConfiguration.WSHttpBinding_IEchoService))
            {
                return new System.ServiceModel.EndpointAddress("https://localhost:5001/EchoService/WSHttps");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
